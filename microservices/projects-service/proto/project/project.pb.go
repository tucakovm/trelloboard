...
var file_project_proto_rawDesc = []byte{
	...
	0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65,
...
var file_project_proto_depIdxs = []int32{
	14, // 0: Project.completionDate:type_name -> google.protobuf.Timestamp
	...
	8,  // 15: ProjectService.GetAllProjects:output_type -> GetAllProjectsRes
	6,  // 16: ProjectService.Create:output_type -> EmptyResponse
	6,  // 17: ProjectService.Delete:output_type -> EmptyResponse
	12, // 18: ProjectService.GetById:output_type -> GetByIdRes
	6,  // 19: ProjectService.AddMember:output_type -> EmptyResponse
	2,  // 20: ProjectService.UserOnProject:output_type -> UserOnProjectRes
	6,  // 21: ProjectService.RemoveMember:output_type -> EmptyResponse
	2,  // 22: ProjectService.UserOnOneProject:output_type -> UserOnProjectRes
